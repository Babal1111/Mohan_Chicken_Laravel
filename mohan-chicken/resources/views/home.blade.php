...
<div class="relative min-h-screen bg-cover bg-center bg-no-repeat flex items-center justify-center"
    ...
    <div class="relative z-10 container mx-auto px-4 py-12">
        <div class="text-center mb-10">
            <h1 class="text-4xl md:text-5xl font-extrabold text-white mb-4">🍗 Mohan Chicken 🍗</h1>
            <p class="text-lg md:text-xl text-gray-100 mb-6">
                Welcome to <span class="font-semibold text-yellow-300">Mohan Chicken</span> –<br>
        ...
        <div class="grid grid-cols-1 md:grid-cols-3 gap-8">
            <div class="bg-white/90 rounded-lg shadow p-6">
